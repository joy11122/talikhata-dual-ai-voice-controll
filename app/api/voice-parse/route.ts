...
function extractBalanceEntityName(transcript: string): string | null {
  ...
  const patterns = [
    ...
    /^(.+?)(?:এর|র)\s+(?:মোট\s+)?(?:কত)\s+(?:টাকা|টাকায়|টাকার)?\s*(?:বাকি|পাওনা|দেনা|ব্যালেন্স)\s*$/i,
    /^(.+?)(?:এর|র)\s+(?:মোট\s+)?(?:বাকি|পাওনা|দেনা|ব্যালেন্স)\s+(?:কত|কতো)\s+(?:টাকা|টাকায়|টাকার)\s*$/i,
    /^(.+?)(?:এর|র)\s+(?:বাকি|পাওনা|দেনা|ব্যালেন্স)\s*কত\s*$/i,
